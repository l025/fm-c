...
export default function CrewContent({ data }) {
  ...
  return (
    <>
      <main
        className={
          'flex justify-center items-start md:items-start min-h-screen bg-neutral-100 bg-cover' +
        ...
        <div className="container max-w-full">
          <div className="flex flex-col md:gap-6 items-center justify-center min-h-screen xl:relative xl:justify-between xl:items-start mx-8 xl:mx-32 xl:pb-10 text-center xl:text-left">
            <h1 className="flex gap-6 my-6 w-full justify-center md:justify-start py-20 md:pt-32 xl:mt-20">
            ...
            <div className="flex-1 flex flex-col xl:flex-row items-center w-full">
              <div className="xl:flex-1 flex justify-center">
                <div className="flex items-center w-screen h-64 md:h-96 overflow-hidden">
                  <img
                    src={
              ...
              <div className="flex flex-col xl:flex-1 my-8 xl:absolute xl:bottom-10">
                <div className="flex justify-center xl:justify-start gap-4 xl:gap-10 nav-text uppercase">
                  {data.map((item, i) => (
                    <a
                      key={item.name}
                      href={'#' + item.name}
                      className={
                        'flex items-center justify-center w-10 h-10 md:w-[56px] md:h-[56px] border border-secondary/25 rounded-full hover:bg-white/70' +
              ...
              <div className="flex-1 flex flex-col h-full">
                {current && (
                  <div className="flex flex-col gap-6 md:max-w-[57ch] xl:max-w-[56ch]">
                    ...
                    <p className="text-secondary pb-6">{current.description}</p>
                  </div>
                )}
              </div>
            </div>
